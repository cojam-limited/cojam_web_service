...
public class CojamToken extends SmartContract {
    ...
    public RemoteCall<KlayTransactionReceipt.TransactionReceipt> allowance(String owner, String spender) {
    ...
    public RemoteCall<KlayTransactionReceipt.TransactionReceipt> isFrozen(String target) {
        final Function function = new Function(
                FUNC_ISFROZEN, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(target)), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<KlayTransactionReceipt.TransactionReceipt> lockInfo(String locked, BigInteger index) {
        final Function function = new Function(
                FUNC_LOCKINFO, 
    ...
    public RemoteCall<KlayTransactionReceipt.TransactionReceipt> owner() {
        final Function function = new Function(
                FUNC_OWNER, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<KlayTransactionReceipt.TransactionReceipt> paused() {
        final Function function = new Function(
                FUNC_PAUSED, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<KlayTransactionReceipt.TransactionReceipt> totalLocked(String locked) {
        final Function function = new Function(
                FUNC_TOTALLOCKED, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(locked)), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<KlayTransactionReceipt.TransactionReceipt> totalSupply() {
        final Function function = new Function(
                FUNC_TOTALSUPPLY, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<KlayTransactionReceipt.TransactionReceipt> name() {
        final Function function = new Function(
                FUNC_NAME, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<KlayTransactionReceipt.TransactionReceipt> symbol() {
        final Function function = new Function(
                FUNC_SYMBOL, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<KlayTransactionReceipt.TransactionReceipt> decimals() {
        final Function function = new Function(
                FUNC_DECIMALS, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
