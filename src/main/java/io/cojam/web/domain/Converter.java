...
public class Converter {
    ...
    public static byte[] bigIntegerTo32PaddedByteArray(BigInteger integer) {
        byte[] inputBytes = integer.toByteArray();
        return Bytes.concat(new byte[32 - inputBytes.length], inputBytes);
    }
