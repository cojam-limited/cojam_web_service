...
public class WalletCode {
    ...
    public static final String RECOMMEND_M_AMOUNT = "500";
    public static final String RECOMMEND_R_AMOUNT = "1000";

    public static final String JOIN_REWARD_AMOUNT = "200000";
}
