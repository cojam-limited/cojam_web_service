...
public class WalletController {
    ...
    public ResponseDataDTO transfer(@AuthenticationPrincipal Account account
            ...
            ,@NotNull(message = "code 필드가 존재해야 합니다.") @NotEmpty(message = "code 값이 존재해야 합니다.") String code
    ...
    @ResponseBody
    @RequestMapping(value = "/api/v1/totalSupply", method= RequestMethod.GET)
    public String totalSupply() throws Exception {
        return contractApplicationService.getTotalSupply();
    }
