...
public class ExceptionHandlingController implements ErrorController {
    ...
    // 에러 페이지 정의
    private final String ERROR_404_PAGE_PATH = "thymeleaf/error/404";
    private final String ERROR_500_PAGE_PATH = "thymeleaf/error/500";
    private final String ERROR_ETC_PAGE_PATH = "thymeleaf/error/error";
