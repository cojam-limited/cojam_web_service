					...
					<form name="joinForm" method="post" action="#">
						<fieldset>
							...
							<div>
								...
								<a href="join.html" class="active">Sing up</a>
							</div>
							<ul>
								<li>
									<input type="text" name="id" title="ID" maxlength="20" class="id-icn" placeholder="ID" />
								</li>
								<li>
									<input type="password" name="pw" title="Password" maxlength="20" class="pw-icn" placeholder="PASSWORD" />
                </li>
                <li>
									<input type="password" name="pw" title="Confirm Password" maxlength="20" class="pw-icn" placeholder="Confirm Password" />
                </li>
                <li>
									<input type="text" name="email" title="email" maxlength="35" class="email-icn" placeholder="E-Mail" />
                </li>
                <li>
									<input type="text" name="name" title="name" maxlength="20" class="name-icn" placeholder="Name" />
								</li>
              </ul>
              <ol>
                <li>
                  <input type="checkbox" name="" value="" id="AgreeAllChk" title="Agree all" />
									<label for="AgreeAllChk">Agree all</label>
                </li>
                <li>
                  <input type="checkbox" name="" value="" id="AgreeChk1" title="Information collected while the users use services" />
                ...
                <li>
                  <input type="checkbox" name="" value="" id="AgreeChk2" title="Information to be collected and method of collection (Necessary)" />
                  ...
                  <h3>
                    ...
                    6. Account holders agree to comply with the laws of any applicable jurisdiction regarding privacy and data protection. Account holders further agree not to do any act, or refrain from doing any act, which would cause Cojam to be in breach of any and all privacy and data protection laws, codes or agreements relating thereto.
							...
							<p>
								<a href="joinComplete.html">Submit</a>
							</p>
						</fieldset>
					</form>
				</div>
